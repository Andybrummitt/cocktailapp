import { addContentToRootDiv, fetchCocktail, addLoading, removeLoading, filterDrinksByInput, addNoResultsText, clearField, getIngredientsListElFromArticle } from "../controllers/util-functions";
